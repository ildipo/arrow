...
//                             const std::vector<ArgShape>& shapes, std::string_view
//                             json);
//
...
//       gen =
//           MakeTransferredGenerator(std::move(gen),
//           ::arrow::internal::GetCpuThreadPool());
//     } else {
...
//                                         json_strings, int multiplicity = 1);
//
// ARROW_TESTING_EXPORT
...
///// Each id has rows corresponding to a singular data point in the time range (start,
/// end,
